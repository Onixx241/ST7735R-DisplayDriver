...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, SD_ChipSelect_Pin|ChipReset_Pin|TFT_ChipSelect_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DataCommand_GPIO_Port, DataCommand_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : SD_ChipSelect_Pin ChipReset_Pin TFT_ChipSelect_Pin */
  GPIO_InitStruct.Pin = SD_ChipSelect_Pin|ChipReset_Pin|TFT_ChipSelect_Pin;
  ...
  GPIO_InitStruct.Pin = DataCommand_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DataCommand_GPIO_Port, &GPIO_InitStruct);
